...
listePartie.push(
  new Partie(
    '1',
    new Joueur('1', 'Albert', 'Ramos', 28, 56, 'Espagne'),
    new Joueur('2', 'Milos', 'Raonic', 28, 16, 'Canada'),
    '1',
    'Hale',
    '12h30',
    0 ));
listePartie.push(
  new Partie(
    '2',
    new Joueur('3', 'Andy', 'Murray', 28, 132, 'Angleterre'),
    new Joueur('4', 'Andy', 'Roddick', 36, 1000, 'États-Unis'),
    '2',
    'Hale',
    '13h00',
    30));
